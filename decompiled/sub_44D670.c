struct std::locale::facet *__usercall sub_44D670@<eax>(int a1@<edi>)
{
  int v1; // ebx
  unsigned int v2; // esi
  int v3; // eax
  ...
  v13 = 0;
  v1 = dword_4D8DCC;
  v9 = (struct std::locale::facet *)dword_4D8DCC;
  if ( !dword_4D6DB4 )
  {
    std::_Lockit::_Lockit((std::_Lockit *)v10, 0);
    if ( !dword_4D6DB4 )
      dword_4D6DB4 = ++dword_4D6DA8;
    std::_Lockit::~_Lockit((std::_Lockit *)v10);
  }
  v2 = dword_4D6DB4;
  v3 = *(_DWORD *)a1;
  if ( (unsigned int)dword_4D6DB4 >= *(_DWORD *)(*(_DWORD *)a1 + 12) )
  {
    v4 = 0;
  }
  else
  {
    v4 = *(struct std::locale::facet **)(*(_DWORD *)(v3 + 8) + 4 * dword_4D6DB4);
    if ( v4 )
    {
LABEL_11:
      v6 = v4;
