struct std::locale::facet *__usercall sub_44B280@<eax>(int a1@<edi>)
{
  int v1; // ebx
  unsigned int v2; // esi
  int v3; // eax
  ...
  int v7; // eax
  struct std::locale::facet *v9; // [esp+Ch] [ebp-24h] BYREF
  _BYTE v10[4]; // [esp+10h] [ebp-20h] BYREF
  _BYTE v11[4]; // [esp+14h] [ebp-1Ch] BYREF
  ...
  v13 = 0;
  v1 = dword_4D8DC0;
  v9 = (struct std::locale::facet *)dword_4D8DC0;
  if ( !dword_4DBEF4 )
  {
    std::_Lockit::_Lockit((std::_Lockit *)v10, 0);
    if ( !dword_4DBEF4 )
      dword_4DBEF4 = ++dword_4D6DA8;
    std::_Lockit::~_Lockit((std::_Lockit *)v10);
  }
  v2 = dword_4DBEF4;
  v3 = *(_DWORD *)a1;
  if ( (unsigned int)dword_4DBEF4 >= *(_DWORD *)(*(_DWORD *)a1 + 12) )
  {
    v4 = 0;
  }
  else
  {
    v4 = *(struct std::locale::facet **)(*(_DWORD *)(v3 + 8) + 4 * dword_4DBEF4);
    if ( v4 )
    {
LABEL_11:
      v6 = v4;
