_DWORD *__thiscall sub_445BD0(void *this, _DWORD *a2, int a3, int a4, int a5, int a6, int a7, _DWORD *a8, int a9)
{
  int v9; // esi
  _DWORD *v10; // ebp
  _DWORD *v12; // eax
  ...
  if ( (unsigned __int8)sub_44BB00(&a5, &a3) )
    *v10 |= 1u;
  if ( (char *)v28 == v22 || v23 || v19 > 0xFFFF )
  {
    *v10 |= 2u;
  }
  else
